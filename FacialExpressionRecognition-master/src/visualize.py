...
def plot_loss(his, ds,name):
    ...
    plt.legend(loc='best')
    plt.savefig(f'./assets/{name}_his_loss.png')


def plot_acc(his, ds,name):
    """
    ...
    plt.legend(loc='best')
    plt.savefig(f'./assets/{name}_his_acc.png')
...
if __name__ == '__main__':
    ...
    plot_loss(history, "fer","test")
    plot_acc(history, "fer","test")
