...
def predict_expression(img_path, model):
    ...
    if not os.path.exists("./output"):
        os.makedirs("./output")
    cv2.imwrite(f'./output/{int(time.time() * 1000)}.png', img)
    print(emotions)
    print(result_possibilitys)
...
if __name__ == '__main__':
    ...
    # model.load_weights('../models/new/jaf_cnn_best_weights.h5')
    model.load_weights('../models/new/ck_cnn_best_weights.h5')
    predict_expression('../input/my/test2.png', model)
