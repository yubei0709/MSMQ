...
class blazeFaceDetector():
	...
	def initializeModel(self, type):
		if type == "front":
			self.interpreter = tf.lite.Interpreter(model_path=os.path.join(r"./blazeface/weights/face_detection_front.tflite"))
		elif type =="back":
			self.interpreter = tf.lite.Interpreter(model_path=os.path.join(r"./blazeface/weights/face_detection_back.tflite"))
