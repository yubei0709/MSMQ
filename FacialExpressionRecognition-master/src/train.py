...
if opt.dataset == "fer2013":
    ...
    callback = [
        ...
        ModelCheckpoint('../models/new/fer2013_cnn_best_weights.h5', monitor='val_accuracy', verbose=True, save_best_only=True,
    ...
    callback = [
        ...
        ModelCheckpoint('../models/new/jaf_cnn_best_weights.h5', monitor='val_accuracy', verbose=True, save_best_only=True,
                        save_weights_only=True)]
    ...
    callback = [
        #     EarlyStopping(monitor='val_loss', patience=50, verbose=True),
        #     ReduceLROnPlateau(monitor='lr', factor=0.1, patience=15, verbose=True),
        ModelCheckpoint('../models/new/ck_cnn_best_weights.h5', monitor='val_accuracy', verbose=True, save_best_only=True,
                        save_weights_only=True)]
...
if opt.plot_history:
    ...
    plot_loss(his.history, opt.dataset,opt.dataset)
    plot_acc(his.history, opt.dataset,opt.dataset)
